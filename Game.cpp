...
void Game::loadScenes() {
   ...
   */
    ...
    _scenes.insert(std::make_pair("portada", new SceneTemporal(this, &_window, "level1", 5, "", "test2")));
    ...
    _scenes.insert(std::make_pair("level4", new scenePlayable(this, & _window, "level3", "level4", "test2", &_player)));
